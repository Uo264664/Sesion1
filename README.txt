...
a persistence unit "getioneitorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "getioneitor/pom.xml":
...
artifact ("getioneitor.war") is already built. You can build
